...
def submit():
    if(option =='1'):
        ...
        for details in exercise_details:
            ...
            exercise_all_details.append("The details of "+str(d)+"nd element")
            exercise_all_details.append("The name of Exercise = "+Name)
            exercise_all_details.append("The equipment used = "+equipment)
            exercise_all_details.append("URL = "+url)
            exercise_all_details.append("Target = "+target)
            secondary_muscles_dict = details['secondaryMuscles']
            exercise_all_details.append("The secondary muscles which would be developed are: ")
            for muscles in secondary_muscles_dict:
                exercise_all_details.append(muscles)
            instructions= details['instructions']
            c = 1
            for instruction in instructions:
                exercise_all_details.append(str(c)+" : "+instruction)
                c+=1
            d+=1
            exercise_all_details.append('\n')
